...
export type TavernRuntimeControlMethod = 'claimTavernScriptWork' | 'startTavernScriptWork'
  | 'getTavernScriptWorkState' | 'heartbeatTavernScriptRuntime'
  | 'completeTavernHelperEvent' | 'releaseTavernHelperRuntime'
